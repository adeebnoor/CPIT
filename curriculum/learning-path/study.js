...
document.addEventListener('click',function(e){var b=e.target.closest('[data-source-slide]');if(!b)return;e.preventDefault();var section=document.getElementById('source-slide-'+b.dataset.sourceSlide);if(!section)return;var slide=section.closest('.slide');if(slide)go(Number(slide.dataset.i),true);section.open=true;section.scrollIntoView?.({block:'start',behavior:'smooth'});});
})();
