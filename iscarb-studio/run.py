...
os.environ.setdefault("ISCARB_BUILD_ID", "7.2.9-golden-v660-editor-gates")
...
# Keep the approved dark BlackNative/TextGold model, 20 core units, semantic
# source expansions, source figures, time-boxing, Rule 11 micro-case scaffold,
# Rule 19 peer-review quick card, Decision Evidence Boxes, and measurable
