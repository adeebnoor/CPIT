...
os.environ.setdefault("ISCARB_BUILD_ID", "7.2.4")
...
# cognitive-budget / AI-era pedagogy, clean polish, kickoff-aware source mode,
# and kickoff-specific visual presenter specialization.
...
from app.patch_v724_kickoff_presenter import apply_v724_kickoff_presenter_patch

apply_v721_pedagogy_ai_patch(app)
apply_v722_final_polish(app)
apply_v723_kickoff_patch(app)
apply_v724_kickoff_presenter_patch(app)
