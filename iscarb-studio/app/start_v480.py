...
"""ISCARB Faculty Studio v4.8.0 — CIMT visual-output release.
...
PUBLIC_VERSION = "4.8.0"
PIPELINE_ID = "faculty-studio-v4.8.0-cimt-visual-output"
...
def _health_v480():
    ...
    data.update({
        ...
        "public_experience": (
            "ISCARB Faculty Studio v4.8 — approved Arabic-first RTL landing page "
