...
_V670_STYLE = r"""
<style id="iscarb-v712-home-patch">
...
.heroArt{position:relative!important;min-height:350px!important;border-radius:28px;overflow:hidden;background-color:#05070D!important;background-image:none!important;isolation:isolate;display:flex!important;align-items:center!important;justify-content:center!important}
.heroArt>.heroPhoto{display:block!important;position:absolute!important;inset:0!important;width:100%!important;height:100%!important;object-fit:contain!important;object-position:center bottom!important;z-index:1!important;background:#05070D!important}
.heroArt>svg{display:none!important}
.heroArt::before{content:"";position:absolute;inset:0;z-index:2;pointer-events:none;background:linear-gradient(90deg,rgba(5,7,13,.06),rgba(5,7,13,0) 50%,rgba(5,7,13,.03))}
...
@media(max-width:900px){.heroArt{min-height:245px!important}.heroArt>.heroPhoto{object-fit:contain!important;object-position:center bottom!important}.heroArt::after{right:10px;bottom:10px;font-size:8.5px}html[data-lang="ar"] .heroArt::after{right:auto;left:10px}}
</style>
"""
...
def faculty_studio_v670_home():
    ...
    body = body.replace("4.6 · Gate v15", "7.1.2 · IT-wide · Multi-source · Gate v15")
    body = body.replace("Saudi Academic Engineering", "Saudi Engineering Learning System")
    body = body.replace("studio_v460.css?v=4.6.6", "studio_v460.css?v=7.1.2")
    body = body.replace("site_v460.js?v=4.6.6", "site_v460.js?v=7.1.2")
    body = body.replace("studio_v440.js?v=4.6.6", "studio_v440.js?v=7.1.2")
    body = body.replace(
        '<div class="heroArt" aria-hidden="true">',
        '<div class="heroArt" aria-hidden="true"><img class="heroPhoto" src="/static/hero_v670.jpg?v=7.1.2" alt="" loading="eager" decoding="sync" fetchpriority="high">',
        1,
    )
    body = body.replace(
        "</head>",
        _V670_STYLE
        + '\n<script src="/static/site_v671_fix.js?v=7.1.2" defer></script>'
    ...
    return HTMLResponse(
        ...
        headers={
            ...
            "X-ISCARB-Home": "v7.1.2-generic-it-clean-multisource-single-language-original-raster-camel-hero-source-figures-first-gate-v15",
        },
    )