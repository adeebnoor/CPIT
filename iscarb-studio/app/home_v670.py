...
"""ISCARB v6.9.1 production home surface."""
...
_V670_STYLE = r"""
<style id="iscarb-v691-home-patch">
...
.heroArt{position:relative!important;min-height:350px!important;border-radius:28px;overflow:hidden;background-color:#05070D!important;background-image:url('/static/hero_v690.webp?v=6.9.1')!important;background-position:center center!important;background-size:contain!important;background-repeat:no-repeat!important;isolation:isolate}
...
@media(max-width:900px){.heroArt{min-height:245px!important;background-position:center center!important;background-size:contain!important}.heroArt::after{right:10px;bottom:10px;font-size:8.5px}}
</style>
"""
...
def faculty_studio_v670_home():
    ...
    body = body.replace("4.6 · Gate v15", "6.9.1 · Source-Locked")
    body = body.replace("Saudi Academic Engineering", "Saudi Engineering Learning System")
    body = body.replace("studio_v460.css?v=4.6.6", "studio_v460.css?v=6.9.1")
    body = body.replace("site_v460.js?v=4.6.6", "site_v460.js?v=6.9.1")
    body = body.replace("studio_v440.js?v=4.6.6", "studio_v440.js?v=6.9.1")
    body = body.replace(
        "</head>",
        _V670_STYLE + '\n<script src="/static/site_v671_fix.js?v=6.9.1" defer></script>\n</head>',
        1,
    )
    return HTMLResponse(
        body,
        headers={
            ...
            "X-ISCARB-Home": "v6.9.1-source-native-textgold",
        },
    )
