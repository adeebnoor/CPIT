...
.heroArt{position:relative!important;min-height:390px!important;border-radius:28px;overflow:hidden;background:#05070D url('/static/hero_v672.webp?v=6.7.4') 72% center/135% auto no-repeat!important;isolation:isolate}
...
def faculty_studio_v670_home():
    ...
    body=body.replace("studio_v460.css?v=4.6.6","studio_v460.css?v=6.7.4")
    body=body.replace("site_v460.js?v=4.6.6","site_v460.js?v=6.7.4")
    body=body.replace("studio_v440.js?v=4.6.6","studio_v440.js?v=6.7.4")
    body=body.replace("</head>",_V670_STYLE+'\n<script src="/static/site_v671_fix.js?v=6.7.4" defer></script>\n</head>',1)
    return HTMLResponse(body,headers={"Cache-Control":"no-store, no-cache, must-revalidate, max-age=0","Pragma":"no-cache","Expires":"0","X-ISCARB-Version":PUBLIC_VERSION,"X-ISCARB-Home":"v6.7.4-runtime-reliability"})
